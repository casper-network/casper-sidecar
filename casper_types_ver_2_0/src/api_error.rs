...
/// ```
/// use casper_types_ver_2_0::ApiError;
///
/// #[repr(u16)]
/// enum FailureCode {
...
pub enum ApiError {
    ...
    /// [casper_types_ver_2_0::system::auction::Error](crate::system::auction::Error).
    /// ```
    /// # use casper_types_ver_2_0::ApiError;
    ...
    /// [casper_types_ver_2_0::contracts::Error](crate::addressable_entity::Error).
    ///
    /// ```
    /// # use casper_types_ver_2_0::ApiError;
    ...
    /// [casper_types_ver_2_0::system::mint::Error](crate::system::mint::Error).
    /// ```
    /// # use casper_types_ver_2_0::ApiError;
    ...
    /// [casper_types_ver_2_0::system::handle_payment](crate::system::handle_payment::Error).
    /// ```
    /// # use casper_types_ver_2_0::ApiError;
