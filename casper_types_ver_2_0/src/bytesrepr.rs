...
fn ensure_efficient_serialization<T>() {
    ...
    debug_assert_ne!(
        any::type_name::<T>(),
        any::type_name::<u8>(),
        "You should use `casper_types_ver_2_0::bytesrepr::Bytes` newtype wrapper instead of `Vec<u8>` for efficiency"
    );
}
...
mod tests {
    ...
    #[test]
    #[should_panic(
        expected = "You should use `casper_types_ver_2_0::bytesrepr::Bytes` newtype wrapper instead of `Vec<u8>` for efficiency"
    )]
