...
use crate::database::{AggregateDeployInfo, DatabaseReader, DatabaseRequestError};
    ...
    async fn get_latest_deploy_aggregate(
        ...
        respond_with_ok_or_not_found(
            AggregateDeployInfo {
                ...
                deploy_accepted: Some("accepted deploy json".to_string()),
    ...
    async fn get_deploy_by_hash_aggregate(
        ...
        respond_with_ok_or_not_found(
            AggregateDeployInfo {
                ...
                deploy_accepted: Some("accepted deploy json".to_string()),
                deploy_processed: Some("processed deploy json".to_string()),
                deploy_expired: false,
            },
            &mut rng,
        )
