use crate::{
    database::{
        ...
        types::DatabaseSpecificConfiguration,
    },
    sql::tables,
    types::sse_events::{
...
pub struct Migration {
    ...
    pub statement_producers:
        fn(DatabaseSpecificConfiguration) -> Result<Vec<StatementWrapper>, Error>,
...
impl Migration {
    ...
    pub fn migration_1() -> Migration {
        Migration {
            version: Some(1),
            statement_producers: |config: DatabaseSpecificConfiguration| {
    ...
    pub fn get_migrations(
        &self,
        database_specific_configuration: DatabaseSpecificConfiguration,
...
fn migration_1_ddl_statements(
    config: DatabaseSpecificConfiguration,
