...
* `no_message_timeout_in_seconds` - Optional parameter specifying after how many seconds of not receiving any bytes from the connection the Sidecar will restart. Defaults to 120 <!-- TODO what restarts? The sidecar or the connection to the node? -->
